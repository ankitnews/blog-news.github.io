        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                  ...
                  <?php 
                  include "config.php";
                  $category_id=$_GET['cat_slug'];
                  $sql="SELECT * FROM post LEFT JOIN category ON post.category=category.category_id LEFT JOIN user ON post.author=user.user_id WHERE category={$category_id}";
